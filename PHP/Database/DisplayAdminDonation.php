...
$select = "SELECT NAME, EMAIL, TRANSACTION_ID, AMOUNT FROM DONATION";
...
if ($count > 0) {
    echo "<br><div id = \"container\"><table id = \"result\"><tr><th>NAME</th><th>EMAIL</th><th>TRANSACTION ID</th><th>AMOUNT</th></tr>";
    while ($row = mysqli_fetch_assoc($result)) {
        echo "<tr><td>" . $row['NAME'] . "</td><td>" . $row['EMAIL'] . "</td><td>" . $row['TRANSACTION_ID'] . "</td><td>" . $row['AMOUNT'] . "</td></tr>";
    }
    echo "</table></div>";
} else {
